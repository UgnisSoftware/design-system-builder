...
function editor(appDefinition) {
    ...
    function render() {
        ...
        var addViewNodeComponent = (0, _h2.default)('div', { style: { cursor: 'pointer', flex: '0 auto', marginLeft: state.rightOpen ? '-10px' : '0', border: '3px solid #222', borderRight: 'none', background: '#333', height: '40px', display: 'flex', alignItems: 'center' }, on: { click: [SHOW_VIEW_NODES] } }, [(0, _h2.default)('span', { style: { cursor: 'pointer', padding: '0 5px' } }, 'add component (todo: quick add)')]);
