...
function editor(appDefinition) {
    ...
    function render() {
        ...
        .map(function (eventData, index) {
            ...
            return (0, _h2.default)('div', { key: event.emitter.id + index, style: { marginBottom: '5px' } }, [(0, _h2.default)('div', { style: {
                    display: 'flex',
                    marginBottom: '5px',
                    cursor: 'pointer',
                    alignItems: 'center',
