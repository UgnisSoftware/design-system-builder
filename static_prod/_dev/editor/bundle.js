...
function editor(appDefinition) {
    ...
    function ADD_EVENT(propertyName, node) {
        ...
        var eventId = uuid();
        setState(_extends({}, state, { definition: _extends({}, state.definition, (_extends51 = {}, _defineProperty(_extends51, ref.ref, _extends({}, state.definition[ref.ref], _defineProperty({}, ref.id, _extends({}, state.definition[ref.ref][ref.id], _defineProperty({}, propertyName, { ref: 'event', id: eventId }))))), _defineProperty(_extends51, "event", _extends({}, state.definition.event, _defineProperty({}, eventId, {
                type: propertyName,
                emitter: node,
                mutators: [],
                data: []
    ...
    function ADD_TRANSFORMATION(pipeId, transformation) {
        if (transformation === 'join') {
            ...
            setState(_extends({}, state, { definition: _extends({}, state.definition, {
                    ...
                    pipe: _extends({}, state.definition.pipe, (_extends54 = {}, _defineProperty(_extends54, newPipeId, {
                        type: 'text',
                        value: 'Default text',
                        transformations: []
                    }), _defineProperty(_extends54, pipeId, _extends({}, state.definition.pipe[pipeId], {
        ...
        if (transformation === 'add') {
            ...
            setState(_extends({}, state, { definition: _extends({}, state.definition, {
                    ...
                    pipe: _extends({}, state.definition.pipe, (_extends62 = {}, _defineProperty(_extends62, _newPipeId, {
                        type: 'number',
                        value: 0,
                        transformations: []
                    }), _defineProperty(_extends62, pipeId, _extends({}, state.definition.pipe[pipeId], {
        ...
        if (transformation === 'subtract') {
            ...
            setState(_extends({}, state, { definition: _extends({}, state.definition, {
                    ...
                    pipe: _extends({}, state.definition.pipe, (_extends64 = {}, _defineProperty(_extends64, _newPipeId2, {
                        type: 'number',
                        value: 0,
                        transformations: []
                    }), _defineProperty(_extends64, pipeId, _extends({}, state.definition.pipe[pipeId], {
