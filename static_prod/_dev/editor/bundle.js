...
function editor(appDefinition) {
    ...
    function VIEW_DRAGGED(nodeRef, e) {
        e.preventDefault();
        var isArrow = e.target.dataset.closearrow;
    ...
    var arrowIcon = function arrowIcon(rotate) {
        return (0, _h2.default)('i', { attrs: { class: 'material-icons', 'data-closearrow': true }, style: { transition: 'all 0.2s', transform: rotate ? 'rotate(-90deg)' : 'rotate(0deg)', cursor: 'pointer' } }, 'expand_more');
    };
