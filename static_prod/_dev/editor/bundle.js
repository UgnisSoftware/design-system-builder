...
function editor(appDefinition) {
    ...
    function render() {
        ...
        var addViewNodeComponent = (0, _h2.default)('div', { style: { flex: '0 auto', marginLeft: state.rightOpen ? '-10px' : '0', border: '3px solid #222', borderRight: 'none', background: '#333', height: '40px', display: 'flex', alignItems: 'center' }, on: { click: [SHOW_VIEW_NODES] } }, [(0, _h2.default)('span', { style: { padding: '0 10px' } }, 'add component: '), (0, _h2.default)('svg', {
            attrs: { width: 14, height: 15 },
            style: { cursor: 'pointer', padding: '0 7px 0 0' },
