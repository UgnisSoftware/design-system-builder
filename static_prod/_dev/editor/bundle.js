...
function editor(appDefinition) {
    ...
    function render() {
        ...
        var leftComponent = (0, _h2.default)('div', {
            ...
            return (0, _h2.default)('div', { style: { padding: '5px', color: '#ffffff' } }, [(0, _h2.default)('div', { style: { cursor: 'pointer', background: '#333', borderRadius: '10px', padding: '5px' }, on: { click: [VIEW_NODE_SELECTED, event.emitter] } }, [event.emitter.ref + ': ' + event.type]), (0, _h2.default)('div', Object.keys(eventData.mutations).map(function (stateId) {
