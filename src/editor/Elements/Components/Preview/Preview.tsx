...
import AddingAtom from './AddingAtom'
...
const Preview = () => {
  const component = state.elements.components.find(comp => comp.id === state.ui.router[1])

  if (!component) {
    return <Wrapper>No Component found</Wrapper>
  }
