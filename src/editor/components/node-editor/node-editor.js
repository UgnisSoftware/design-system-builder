        ...
        [
            h(
                ...
                [
                                        ...
                                        state.selectedViewNode.id === '_rootNode'
                                            ...
                                            : state.selectedViewNode.ref === 'vNodeBox'
                                              ...
                                              : state.selectedViewNode.ref === 'vNodeList'
                                                ? listIcon()
                                                : state.selectedViewNode.ref === 'vNodeList' ? ifIcon() : state.selectedViewNode.ref === 'vNodeInput' ? inputIcon() : state.selectedViewNode.ref === 'vNodeImage' ? imageIcon() : textIcon(),
                                    ]
                                ),
                                h(
                                    'span',
                    ...
                    fullVNode ? tabs() : h('span'),
                    dragSubComponentRight,
                    dragSubComponentLeft,
                    state.selectedViewSubMenu === 'props' || !fullVNode
                        ? propsSubmenuComponent()
                        : state.selectedViewSubMenu === 'style' ? styleSubmenuComponent() : state.selectedViewSubMenu === 'events' ? eventsSubmenuComponent() : h('span', 'Error, no such menu'),
                    inheritedStates.length
                        ? h(
                              'div',
                              { style: { padding: '20px', background: '#1e1e1e', marginTop: 'auto' } },
