...
import {
    ...
    DELETE_STATE,
    CHANGE_CURRENT_STATE_BOOLEAN_VALUE,
    CHANGE_CURRENT_STATE_BOOLEAN_VALUE_TABLE,
    CHANGE_CURRENT_STATE_TEXT_VALUE,
    CHANGE_CURRENT_STATE_TEXT_VALUE_TABLE,
    CHANGE_CURRENT_STATE_NUMBER_VALUE,
...
import { deleteIcon, listIcon, saveIcon, ifIcon, inputIcon, textIcon, boxIcon, numberIcon } from '../icons'
        ...
        [
            h(
                'button',
                {
                    ...
                    on: {
                        click: [ADD_STATE, '_rootNameSpace', 'text'],
                    },
                },
                [textIcon()]
            ),
            h(
                'button',
                {
                    ...
                    on: {
                        click: [ADD_STATE, '_rootNameSpace', 'number'],
                    },
                },
                [numberIcon()]
            ),
            h(
                'button',
                {
                    ...
                    on: {
                        click: [ADD_STATE, '_rootNameSpace', 'boolean'],
                    },
                },
                [ifIcon()]
            ),
            h(
                'button',
                {
                    ...
                    on: {
                        click: [ADD_STATE, '_rootNameSpace', 'table'],
                    },
                },
                [listIcon()]
            ),
        ...
        [
            h(
                ...
                [
                    ...
                    h('div', { style: { display: 'inline-flex' } }, [liveEditor(stateRef)]),
                    h(
                        'div',
                        {
                            style: {
    ...
    h(
        ...
        [
            ...
            h(
                ...
                [h('span', 'COMPONENTS STATE '), h('span', 'CURRENT VALUE')]
            ),
