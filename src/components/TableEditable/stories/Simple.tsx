...
export const OnRowClick = () => {
  ...
  return <TableEditable columns={columns} rows={data} onRowClick={(data) => alert(JSON.stringify(data))} />
}
...
export const WithSurroundingContent = () => {
  ...
  return (
    <div>
      ...
      <TableEditable columns={columns} rows={data} />
    </div>
  )
}

export const Empty = () => {
  return <TableEditable columns={columns} rows={[]} />
}
