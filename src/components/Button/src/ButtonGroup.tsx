import { chakra, forwardRef, SystemProps, SystemStyleObject, ThemingProps, HTMLChakraProps } from "../../../system"
...
export const ButtonGroup = forwardRef<ButtonGroupProps, "div">((props, ref) => {
  const { size, colorScheme, variant, className, spacing = "0.5rem", isAttached, isDisabled, ...rest } = props
  ...
  return (
    <ButtonGroupProvider value={context}>
      <chakra.div ref={ref} role="group" __css={groupStyles} className={_className} {...rest} />
    </ButtonGroupProvider>
  )
})
