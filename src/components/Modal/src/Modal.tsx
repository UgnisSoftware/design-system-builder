...
import { callAllHandlers, cx, FocusableElement, __DEV__ } from "~/utils"
...
export const ModalContent = forwardRef<ModalContentProps, "section">((props, ref) => {
  ...
  const { getDialogProps, getDialogContainerProps, preserveScrollBarGap, allowPinchZoom, blockScrollOnMount } =
    useModalContext()
  ...
  return (
    <RemoveScroll removeScrollBar={!preserveScrollBarGap} allowPinchZoom={allowPinchZoom} enabled={blockScrollOnMount}>
      <chakra.div {...containerProps} className="chakra-modal__content-container" __css={dialogContainerStyles}>
        <ModalTransition preset={motionPreset} className={_className} {...dialogProps} __css={dialogStyles}>
          {children}
        </ModalTransition>
      </chakra.div>
    </RemoveScroll>
...
export interface ModalOverlayProps
  extends Omit<HTMLMotionProps<"div">, "color" | "transition" | "css">,
 ...
 */
export const ModalOverlay = forwardRef<ModalOverlayProps, "div">((props, ref) => {
  ...
  return <Motion {...motionProps} __css={overlayStyle} ref={ref} className={_className} {...rest} />
})
...
export const ModalHeader = forwardRef<ModalHeaderProps, "header">((props, ref) => {
  ...
  return <chakra.header ref={ref} className={_className} id={headerId} {...rest} __css={headerStyles} />
})
...
export const ModalBody = forwardRef<ModalBodyProps, "div">((props, ref) => {
  ...
  return <chakra.div ref={ref} className={_className} id={bodyId} {...rest} __css={styles.body} />
})
...
export const ModalFooter = forwardRef<ModalFooterProps, "footer">((props, ref) => {
  ...
  return <chakra.footer ref={ref} {...rest} __css={footerStyles} className={_className} />
})
 ...
 */
export const ModalCloseButton = forwardRef<CloseButtonProps, "button">((props, ref) => {
