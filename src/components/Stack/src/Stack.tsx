import { chakra, ChakraComponent, forwardRef, HTMLChakraProps, SystemProps } from "../../../system"
...
export const StackItem: React.FC<HTMLChakraProps<"div">> = (props) => {
  return (
    <chakra.div
...
export const Stack = forwardRef<StackProps, "div">((props, ref) => {
  ...
  const styles = React.useMemo(() => getStackStyles({ direction, spacing }), [direction, spacing])

  const dividerStyle = React.useMemo(() => getDividerStyles({ spacing, direction }), [spacing, direction])
  ...
  const clones = shouldUseChildren
    ...
    : validChildren.map((child, index) => {
        ...
        const clonedDivider = React.cloneElement(divider as React.ReactElement<any>, { __css: dividerStyle })
