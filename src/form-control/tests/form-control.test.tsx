...
test("only displays error icon and message when invalid", () => {
  const { rerender } = render(
    <FormControl id="name" isInvalid>
      ...
      <FormErrorMessage data-testid="message">Your name is invalid</FormErrorMessage>
    </FormControl>,
  )
...
test("has the proper aria attributes", async () => {
  ...
  rerender(
    <FormControl id="name" isRequired isInvalid isReadOnly>
      ...
      <Input placeholder="Name" />
      <FormHelperText>Enter your name please!</FormHelperText>
      <FormErrorMessage data-testid="error">Your name is invalid</FormErrorMessage>
    </FormControl>,
  )
  ...
  expect(input).toHaveAttribute("aria-describedby", "name-feedback name-helptext")
...
test("has the correct data attributes", async () => {
  render(
    <FormControl data-testid="control" id="name" isRequired isInvalid isDisabled isReadOnly>
      <FormLabel data-testid="label">Name</FormLabel>
      <RequiredIndicator data-testid="indicator" />
      <Input placeholder="Name" />
      <FormHelperText data-testid="helper-text">Please enter your name!</FormHelperText>
      <FormErrorMessage data-testid="error-message">Your name is invalid.</FormErrorMessage>
    </FormControl>,
  )
