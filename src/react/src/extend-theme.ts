import defaultTheme, { ChakraTheme, Theme } from "../../theme"
...
type DeepThemeExtension<BaseTheme, ThemeType> = {
  [Key in keyof BaseTheme]?: BaseTheme[Key] extends (...args: any[]) => any
    ? DeepThemeExtension<Partial<ReturnType<BaseTheme[Key]>>, CloneKey<ThemeType, Key>>
...
export type ThemeOverride = Partial<ChakraTheme> & DeepThemeExtension<Theme, ChakraTheme>
