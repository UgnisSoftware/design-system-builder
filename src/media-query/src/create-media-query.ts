import type { Dict, StringOrNumber } from "../../utils"
...
export default function createMediaQueries(breakpoints: Dict): MediaQuery[] {
  return (
    Object.entries(breakpoints)
      ...
      .sort((a, b) => (Number.parseInt(a[1], 10) > Number.parseInt(b[1], 10) ? 1 : -1))
...
const calculateMeasurement = (value: StringOrNumber, modifier: number): string => {
